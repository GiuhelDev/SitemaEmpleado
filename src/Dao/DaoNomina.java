...
public class DaoNomina {
    ...
    public DefaultTableModel listar(){
        ...
        String [] titulos={"ID Nomina","Fecha","IDEMPLEADO","Nombre","Apellido","Documento",
            "IDCargo","Cargo","Precio C","Cant","Total"};
     ...
     public boolean Buscar(nomina no){
      ...
      public int CantNominaP(String estado){
       String sql="SELECT COUNT(id)as cant from nomina where estado = '"+estado+"'";
       int cant = 0;
       try{
            con=cn.conectar();
            ps=con.prepareStatement(sql);
   ...
   public int CantNominaT(){
       String sql="SELECT COUNT(id)as cant from nomina";
       int cant = 0;
       try{
            con=cn.conectar();
            ps=con.prepareStatement(sql);
